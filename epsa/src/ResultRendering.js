...
window.renderDashboardWithData = function (data) {
    ...
    const statConfigs = [
        ...
        { key: 'showEffectiveBlocksNum', icon: './assets/EffectiveBlocksIcon.svg', label: '有效', value: stats.EffectiveBlocksNum },
        { key: 'showScriptsNum', icon: './assets/ScriptsIcon.svg', label: '合计', value: stats.ScriptsNum },
        { key: 'showEffectiveScriptsNum', icon: './assets/EffectiveScriptsIcon.svg', label: '有效', value: stats.EffectiveScriptsNum },
