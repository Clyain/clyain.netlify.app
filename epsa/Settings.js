...
const settingCheckboxes = {
    ...
    showEffectiveBlocksNum: document.getElementById('showEffectiveBlocksNum'),
    showScriptsNum: document.getElementById('showScriptsNum'),
    showEffectiveScriptsNum: document.getElementById('showEffectiveScriptsNum'),
